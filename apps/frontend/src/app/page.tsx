      ...
      <section className="relative bg-gradient-to-br from-blue-600 to-blue-800 text-white">
        <div className="container mx-auto px-4 py-20 md:py-32">
          <div className="max-w-4xl mx-auto text-center">
            <h1 className="text-4xl md:text-6xl font-bold mb-6">Find Your Perfect Tutor Nearby</h1>
            ...
            <div className="space-y-8">
              ...
              <div className="flex gap-6 items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Enter your location and find qualified tutors nearby. Filter by subject, rate,
                    and ratings.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-6 items-start">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Watch demo videos, read reviews, and check availability to find your perfect
                    match.
                  </p>
                </div>
              </div>
