      ...
      <main className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        <div className="px-4 py-6 sm:px-0 space-y-6">
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <h2 className="text-2xl font-bold text-gray-900 mb-4">Tutor Dashboard</h2>
            <p className="text-gray-600 mb-6">Manage your profile, availability, and bookings.</p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              >
                <h3 className="text-lg font-semibold text-blue-900 mb-2">My Profile</h3>
                <p className="text-sm text-blue-700">Update your profile and demo videos</p>
              </Link>
              ...
              >
                ...
                <p className="text-sm text-green-700">Set your available time slots</p>
              </Link>
              ...
              >
                <h3 className="text-lg font-semibold text-purple-900 mb-2">My Sessions</h3>
                <p className="text-sm text-purple-700">View upcoming and past sessions</p>
              </Link>
              ...
              >
                <h3 className="text-lg font-semibold text-yellow-900 mb-2">Messages</h3>
                <p className="text-sm text-yellow-700">Chat with your students</p>
              </Link>
            </div>
          </div>
